...
<<<<<<< HEAD
  ...
  function startPickFlow(team, pickNum) {
    ...
    if (remainingPicks > 0) {
      ...
      setModalState('export'); // Keep export modal open
    }
  }
...
<<<<<<< HEAD
      ...
      {/* Lane Select Modal */}
      <LaneSelectModal
        open={modalState === 'export' && pickerStep === 'lane' && currentPickSession}
        onClose={() => {
          setCurrentPickSession(null);
          setPickerStep('lane');
          setHeroPickerMode(null);
      ...
      <HeroPickerModal
        open={modalState === 'export' && heroPickerMode === 'ban' && heroPickerTarget && !currentPickSession}
        onClose={() => {
      ...
      <HeroPickerModal
        open={modalState === 'export' && pickerStep === 'hero' && pickTarget && pickTarget.lane && currentPickSession}
        onClose={() => {
          setCurrentPickSession(null);
          setPickerStep('lane');
          setHeroPickerSelected([]);
